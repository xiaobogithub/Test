    ...
    */
    RGraph.Highlight          = {};
    RGraph.tooltips           = {};
    RGraph.tooltips.padding   = '10px';
    RGraph.tooltips.font_face = 'Arial';
    ...
    */
    RGraph.Tooltip = function (obj, text, x, y, idx, e)
    {
        ...
        */
        ...
        tooltipObj.style.backgroundColor = 'white';
        tooltipObj.style.color           = 'rgb(67,90,109)';
        ...
        tooltipObj.style.WebkitBoxShadow    = 'rgba(96,96,96,0.5) 0 0 10px';
        tooltipObj.style.MozBoxShadow       = 'rgba(96,96,96,0.5) 0 0 10px';
        tooltipObj.style.boxShadow          = 'rgba(96,96,96,0.5) 0 0 10px';
