...
function showNormalMessage(message) {
    ...
    $(".fadecover,.hideDialoguebox").bind("click",function () {
...
function addClassForHiddenElements() {
    ...
    if (imageMode != undefined && imageMode != null) {
        ...
        } else if (imageMode == "Illustration") {
...
function loadPage(XMLobj) {
    ...
    if ($(pageObj).attr('Type') == 'SMS') {
        ...
        $('#controlBar .button-back').click(function () {
...
function showDialog() {
    ...
    if (settingMenu != null && settingMenu != undefined) {
        $(settingMenu).find("MenuItem").each(function (index, settingMenuItem) {
            ...
            if (functionName == "HelpFunction") {
                if (name != null && name != undefined && name != '') {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="help"><li>' + name + '</li></a>');
                } else {
                    // $('.setting-menu').append('<span><a href="#x" class="help">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="help"><li>' + functionName + '</li></a>');
                }
            ...
            if (functionName == "TipFriendFunction") {
                if (name != null && name != undefined && name != '') {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="mail"><li>' + name + '</li></a></span>');
                } else {
                    // $('.setting-menu').append('<span><a href="#x" class="mail">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="mail"><li>' + functionName + '</li></a></span>');
                }
            ...
            if (functionName == "PauseProgramFunction") {
                if (name != null && name != undefined && name != '') {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="pause"><li>' + name + '</li></a>');
                } else {
                    //$('.setting-menu').append('<span><a href="#x" class="pause">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="pause"><li>' + functionName + '</li></a>');
                }
            ...
            if (functionName == "ProfileFunction") {
                if (name != null && name != undefined && name != '') {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="email"><li>' + name + '</li></a>');
                } else {
                    // $('.setting-menu').append('<span><a href="#x" class="email">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="email"><li>' + functionName + '</li></a>');
                }
            ...
            if (functionName == "ExitProgramFunction") {
                if (name != null && name != undefined && name != '') {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="shutdown"><li>' + name + '</li></a>');
                } else {
                    //$('.setting-menu').append('<span><a href="#x" class="shutdown">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="shutdown" ><li>' + functionName + '</li></a>');
                }
            ...
            if (isSupportTimeZone == "1" || isSupportTimeZone == "true") {
                if (functionName == "TimeZoneFunction") {
                    if (name != null && name != undefined && name != '') {
                        ...
                        $('.settingsmenu').append('<a href="javascript:void(0);" class="timeZone"><li>' + name + '</li></a>');
                    } else {
                        //$('.setting-menu').append('<span><a href="settings-timezone.html">' + functionName + '</a></span>');
                        $('.settingsmenu').append('<a href="javascript:void(0);" class="timeZone"><li>' + functionName + '</li></a>');
                    }
            ...
            if (functionName == "SMSToEmailFunction") {
                if (name != null && name != undefined && name != "") {
                    ...
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="smsToEmail"><li>' + name + '</li></a></span>');
                } else {
                    // $('.setting-menu').append('<span><a href="#x" class="smsToEmail">' + functionName + '</a></span>');
                    $('.settingsmenu').append('<a href="javascript:void(0);" class="smsToEmail"><li>' + functionName + '</li></a></span>');
                }
        ...
        //show settings menu
    $(".hideSettingsmenu").click(function () {
        $("#iframe-settings").hide();
        $(".settings-detail").hide();
        $(".settings-button-close").hide();
    ...
    showSettings();
    $(".settings-detail .settings .cancel").click(function () {
   ...
   /*$('.setting-menu em a').unbind();
    ...
    //FAQ button
    if (hasHelpFunction) {
        $('.settingsmenu a.help').click(function () {
            showSettingContent();
    ...
    if (hasTipFriendFunction) {
        $('.settingsmenu a.mail').click(function () {
            showSettingContent();
            var newEmailAddress = "";
            if (specialStirngs["New_email_address"] != null && specialStirngs["New_email_address"] != undefined && specialStirngs["New_email_address"] != "") {
                newEmailAddress = specialStirngs["New_email_address"];
            ...
            if (tipFriendObj != null && tipFriendObj != undefined) {
                ...
                $('.settings-detail .settings').append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel" >' + tipFriendBackBtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + tipFriendSubmitBtnName + '</a></div>');

                $('.settings-detail .settings .blue').unbind('click');
                $('.settings-detail .settings .blue').click(function () {
    ...
    if (hasPauseProgramFunction) {
        $('.settingsmenu a.pause').click(function () {
            showSettingContent();
            ...
            if (pauseProgramObj != null && pauseProgramObj != undefined) {
                ...
                $('.settings-detail .settings').append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel">' + pauseProBackbtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + pauseProSubmitBtnName + '</a></div>');
                //settingsList();
                $('.settings-detail .settings .blue').unbind('click');
                $('.settings-detail .settings .blue').click(function () {
    ...
    if (hasProfileFunction) {
        $('.settingsmenu a.email').click(function () {
            showSettingContent();
            var newEmailAddress = "";
            if (specialStirngs["New_email_address"] != null && specialStirngs["New_email_address"] != undefined && specialStirngs["New_email_address"] != "") {
                newEmailAddress = specialStirngs["New_email_address"];
            ...
            if (profileObj != null && profileObj != undefined) {
                ...
                $(".settings-detail .settings").append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel">' + profileBackBtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + profileSubmitBtnName + '</a></div>');
                $('.settings-detail .settings .blue').unbind('click');
                $('.settings-detail .settings .blue').click(function () {
    ...
    if (hasExitProgramFunction) {
        $('.settingsmenu a.shutdown').click(function () {
            showSettingContent();
            ...
            if (exitProgramObj != null && exitProgramObj != undefined) {
                ...
                $(".settings-detail .settings").append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel">' + exitProgramBackBtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + exitProgramSubmitBtnName + '</a> </div>');
                //settingsList();
                $('.settings-detail .settings .blue').unbind('click');
                $('.settings-detail .settings .blue').click(function () {
    ...
    if (hasTimeZoneFunction) {
        $('.settingsmenu a.timeZone').click(function () {
            showSettingContent();
            ...
            if (timeZoneObj != null && timeZoneObj != undefined) {
                ...
                $('.settings-detail .settings').append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel">' + timeZoneBackBtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + timeZoneSubmitBtnName + '</a></div>');
    ...
    if (hasSMSToEmailFunction) {
        $('.settingsmenu a.smsToEmail').click(function () {
            showSettingContent();
            ...
            if (smsToEmailObj != null && smsToEmailObj != undefined) {
                ...
                $('.settings-detail .settings').append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink grey cancel">' + smsToEmailBackBtnName + '</a><a href="javascript:void(0);" class="actionlink blue">' + smsToEmailSubmitBtnName + '</a> </div>');
                //settingsList();
                var msg = "";
                ...
                $(".settings-detail .settingMenuSmsToEmail  input:checkbox ").click(function () {
...
function showErrorSettingMessage(title,message,btn) {
    ...
    $('.settings-detail .settings-message').append('<div class="col-1full centeraligned"><a href="javascript:void(0);" class="actionlink blue">' + btn + '</a></div>');
    $(".settings-message").show();
    if (!$("body").hasClass("settings-body")) {
        $("body").addClass("settings-body");
    }
    $(".settings-detail .settings-message .blue").unbind();
    $(".settings-detail .settings-message .blue").click(function () {
        returnToSettingsList();
    });
    $(".settings-button-back .button-back").unbind();
    $(".settings-button-back .button-back").click(function () {
        returnToSettingsList();
    });
}
