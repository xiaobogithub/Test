<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AddHelpItem.aspx.cs" Inherits="ChangeTech.DeveloperWeb.AddHelpItem" ValidateRequest="false" %>
...
<div class="box-main">
    ...
    <tr>
     ...
     <tr>
            ...
            <td>
               <asp:DropDownList ID="OrderDropDownList" runat="server" CssClass="listmenu-default">
                </asp:DropDownList>
            </td>
            <td >&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
               <asp:TextBox ID="QuestionTextBox" runat="server" TextMode="MultiLine"  CssClass="textfield-largetext"></asp:TextBox>
