<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportUserVariableExtension.aspx.cs" 
    Inherits="ChangeTech.DeveloperWeb.ExportUserVariableExtension" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Export user variable extension</title>
...
<body>
    ...
    <div style="text-align: center; vertical-align: middle">
        <div id="header">
            Export user variable extension
        </div>
        <div id="centerPart">
