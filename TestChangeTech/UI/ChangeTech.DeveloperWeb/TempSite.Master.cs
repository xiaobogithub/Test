...
{
    public partial class TempSite : System.Web.UI.MasterPage
    {
        ...
        private void InitOperateDDL()
        {
            ...
            if (SuperAdminPermission)
            {
                ...
                if (Request.PhysicalPath.Equals(Server.MapPath(Constants.URL_DEVELOPER_LIST_PROGRAM)) 
                    || Request.PhysicalPath.Contains("EditProgram.aspx")
                    || Request.PhysicalPath.Contains("EditSession.aspx")
                    || Request.PhysicalPath.Contains("EditPageSequence.aspx")
                    || Request.PhysicalPath.Contains("EditPage.aspx")
                    || Request.PhysicalPath.Contains("PageReview.aspx"))
                {
