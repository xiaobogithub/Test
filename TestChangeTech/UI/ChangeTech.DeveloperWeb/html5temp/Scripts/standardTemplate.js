...
function loadTitleAndText(pageObj) {
    ...
    if (footerText != null && footerText != '' && footerText != undefined) {
        footerText = footerText.replace(/\r\r|\n\n|\r\n\r\n|\n\r\n\r/g, "<br class='emptyline'/>")
    ...
    if (mediaNode != null && mediaNode != undefined) {
        ...
        if (mediaType != null && mediaType != "" && mediaType != undefined) {
            if (mediaType == "Video") {
                ...
                //showIllustrationImage(mediaType, mediaFile); //this function in getInformation template .js
              ...
              /*  if (mediaFile != null && mediaFile != undefined && mediaFile != '') {
                    ...
                    $("#black").append('<img src="' + mediaFileUrl + '" alt="' + mediaFile + '" width="500px" class="illustrationImage"/>');
