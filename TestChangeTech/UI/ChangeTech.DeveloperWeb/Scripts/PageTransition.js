...
function showImage() {
    ...
    if ($("#hiddenImage").text() != '') {
        ...
        var mediaImage = $(mediaObj).attr("Media");
        if (presenterImage != null && presenterImage != "" && presenterImage != undefined) {
                ...
                $(".wrapper-image").html("<img src='" + imageUrl + "' alt='' id='myImage' class='imageMode' style='display:none;'/><div class='box-grey'></div>");
...
//                if ((title == null || title == "" || title == undefined) && (text == null || text == "" || text == undefined) && (footerText == null || footerText == undefined || footerText == "")) {
                    ...
                    $(".wrapper-image").html("<div class='fullscreenimage'  style='display:none;'></div><img src='" + imageUrl + "'id='myImage' style='opacity:0;'/>");
...
//                    }
                    //                }
                } else if ((illustrationImage != null && illustrationImage != undefined && illustrationImage != "") || (mediaType == "Illustration" && mediaImage != "" && mediaImage != undefined && mediaImage !=null)) {
                ...
                $(".wrapper-image").html("<img src='" + imageUrl + "' alt='' id='myImage' class='imageMode' style='display:none;'/>");
            } else {
            }
        } else {
            $(".wrapper-image").html("");
...
function modeChangeAnimation() {
    ...
    if (presenterImage != undefined && presenterImage != null && presenterImage != "") {
        ...
        if (wrapperBub.hasClass("graphtemplate")) {
            wrapperBub.removeClass("graphtemplate");
        }
       if (pageType == "Graph") {
            wrapperBub.addClass("fullscreenmode graphtemplate");
...
//        $('#bubble-white .bubcontent').html('').fadeOut(200);
        ...
        $('#bubble-white .bubcontent').html('').hide();
        $('#bubble-white').hide();
    }
    else if (textElement != "") {
