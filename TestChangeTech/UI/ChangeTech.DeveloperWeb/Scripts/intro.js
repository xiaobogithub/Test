function loadIntroPage(ctppXmlobj, callback) {
    ...
    if (logoImage != '' && logoImage != null && logoImage != undefined) {
        $(".franchise-logo").html("<img src=" + logoUrl + " alt=''  id='plogoImage'/>");
        /*var pLogoImage = $("#plogoImage");
        $(".franchise-logo").imagesLoaded(function (pLogoImage, pLogoImage, pLogoImage) {
            $(".franchise-logo").fadeIn();
        });*/
    }
    var programTitleStr = "";
    if (programTitle != undefined && programTitle != null) {
        programTitleStr = "<span class='programName'>" + programTitle + "</span>";
    }
    if (programName != '' && programName != null && programName != undefined) {
        programTitleStr = "<span class='programName'>" + programName + "</span>";
    }
    $(".programtitle").append(programTitleStr);
