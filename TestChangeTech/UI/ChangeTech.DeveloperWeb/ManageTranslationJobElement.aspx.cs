...
namespace ChangeTech.DeveloperWeb
{
    public partial class ManageTranslationJobElement : PageBase<TranslationJobElementModel>
    {
        ...
        {
            ((HyperLink)Master.FindControl("hpBackLink")).NavigateUrl = string.Format("ManageTranslationJobContent.aspx?{0}={1}", Constants.QUERYSTR_TRANSLATION_JOB_GUID, TranslationJobGUID);
        }
    }
}