<%@ Page Title="" Language="C#" MasterPageFile="~/HealthProfileSystem/HealthProfileSystem.Master" AutoEventWireup="true" CodeBehind="AddNewOrder.aspx.cs" Inherits="ChangeTech.DeveloperWeb.HealthProfileSystem.AddNewOrder" %>
      ...
      <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                ...
                <act:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MM-yyyy" CssClass="cal_Theme1" TargetControlID="txtStartDate">
        ...
        <tr>
            ...
            <td>
                ...
                <act:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd-MM-yyyy" CssClass="cal_Theme1"  TargetControlID="txtStopDate">
                </act:CalendarExtender>
      ...
      <td>&nbsp;</td>
        ...
        <td>&nbsp;</td>
            <td align="right">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="addButton" runat="server" Text="OK" 
                    OnClick="addButton_Click" CssClass="button-open"/>
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
