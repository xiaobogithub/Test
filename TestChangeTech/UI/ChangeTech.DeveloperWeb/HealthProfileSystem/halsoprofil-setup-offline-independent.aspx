<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="halsoprofil-setup-offline-independent.aspx.cs" Inherits="ChangeTech.DeveloperWeb.HealthProfileSystem.halsoprofil_setup_offline_independent" %>
...
a.actionlink {
	...
	font-size: 1.0em;
	color: #FFF;
	background: url(gfx/helseprofil-startpage-gui.png) 180px -8px no-repeat #7c1008;
	border: none;
	-webkit-border-radius: 6px;
	-moz-border-radius: 6px;
	border-radius: 6px;
...
a.prioritylink {
	...
	color: #000;
	padding: 2px 5px 2px 25px;
	background: url(gfx/helseprofil-startpage-gui.png) no-repeat;
...
<form id="form1" runat="server">
 <div class="wrapper-main">
    ...
    <div class="col890 hidden">
      <h2>Om Hälsoprofilen med Företagsrapport</h2>
      <p class="line-spacer">Du kommer nu att få svara på ett antall frågor som handlar om din livsstil och hälsa. Ditt resultat kommer både att redovisas i en personling rapport direkt till dig samtidigt som dina svar ingår i en gemensam sammanstallning för företaget.</p>
    </div>
    <div class="col890 hidden">
      <div class="focusbox">
        <div class="left">
            ...
            <p>&nbsp;</p>
            <p> 
                    <asp:LinkButton ID="actionLink" runat="server" CssClass="actionlink"  Text="Start"/>
                 <%--<a id="actionLink" class="actionlink" href="javascript:__doPostBack(&#39;actionLink&#39;,&#39;&#39;)">Start</a>--%>
             </p>
          </div>
        <%--<div class="right">
          <p> <a id="actionLink" class="actionlink" href="javascript:__doPostBack(&#39;actionLink&#39;,&#39;&#39;)">Start</a> </p>
        </div>--%>
        <div class="clear"></div>
      </div>
    </div>
    <div class="col890 hidden">
      <h4>Sekretess</h4>
      <p>De uppgifter du har lagt in blir fullständigt avidentifierade och kan inte knytas til dig som en enskild individ. Företagsrapporten måste minst omfatta tio individer för att säkerställa att ingen enskild person ska kunna bli igenkänd.</p>
      <p>&nbsp;</p>
      <p><a class="prioritylink" href="https://lansforsakringar.soshalsa.eu/om.html#pul">Läs mer om sekretess på Länsförsäkringars portalsida</a></p>
      <p>&nbsp;</p>
    </div>
    <div class="col890">
      <p align="center">
