...
package com.redbox.changetech.view.templates {
    ...
    public class Quiz extends ModuleViewTemplate implements IBindingClient {

        public var _Quiz_Spacer1:Spacer
        ...
        private var _2085056204answerCorrect:Boolean = false
        ...
        public function Quiz(){
            _documentDescriptor_ = new UIComponentDescriptor({type:ModuleViewTemplate, propertiesFactory:function ():Object{
                return ({childDescriptors:[new UIComponentDescriptor({type:Canvas, id:"transContainer1", propertiesFactory:function ():Object{
                    ...
                    return ({verticalScrollPolicy:"off", childDescriptors:[new UIComponentDescriptor({type:HBox, propertiesFactory:function ():Object{
                        return ({childDescriptors:[new UIComponentDescriptor({type:Spacer, id:"_Quiz_Spacer1"}), new UIComponentDescriptor({type:BalanceImageReflectionCanvas, id:"contentImage"})]});
                    }})]});
                }})]});
            }});
            _bindings = [];
            ...
            this.addEventListener("creationComplete", ___Quiz_ModuleViewTemplate1_creationComplete);
        }
        ...
        public function ___Quiz_ModuleViewTemplate1_creationComplete(_arg1:FlexEvent):void{
            init(_arg1);
        }
        override public function initialize():void{
            ...
            var bindings:* = _Quiz_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_templates_QuizWatcherSetupUtil");
        ...
        private function _Quiz_bindingExprs():void{
            var _local1:*;
        ...
        private function init(_arg1:FlexEvent):void{
            ...
            this.addEventListener(AnswerSelectedEvent.ANSWER_SELECTED, respondToAnswer);
        }
        ...
        private function set answerCorrect(_arg1:Boolean):void{
            var _local2:Object = this._2085056204answerCorrect;
            if (_local2 !== _arg1){
                this._2085056204answerCorrect = _arg1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "answerCorrect", _local2, _arg1));
            };
        }
        ...
        protected function respondToAnswer(_arg1:AnswerSelectedEvent):void{
            trace(("event.actionFlag=" + _arg1.actionFlag));
            if (_arg1.actionFlag == "Correct"){
                answerCorrect = true;
            };
        }
        private function get answerCorrect():Boolean{
            return (this._2085056204answerCorrect);
        }
        ...
        private function _Quiz_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
