...
package com.redbox.changetech.view.components {
    ...
    public class BottomRightBadge extends VBox implements IBindingClient {

        public var _BottomRightBadge_Image1:Image
        mx_internal var _watchers:Array
        mx_internal var _bindingsByDestination:Object
        public var _BottomRightBadge_Label1:Label
        ...
        public function BottomRightBadge(){
            _documentDescriptor_ = new UIComponentDescriptor({type:VBox, propertiesFactory:function ():Object{
                return ({width:100, height:50, childDescriptors:[new UIComponentDescriptor({type:Image, id:"_BottomRightBadge_Image1"}), new UIComponentDescriptor({type:Label, id:"_BottomRightBadge_Label1", stylesFactory:function ():void{
        ...
        private function _BottomRightBadge_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
            binding = new Binding(this, function ():Object{
                return (BalanceModelLocator.getInstance().assets[roomVO.badgeAsset]);
            }, function (_arg1:Object):void{
                _BottomRightBadge_Image1.source = _arg1;
            }, "_BottomRightBadge_Image1.source");
            result[0] = binding;
            binding = new Binding(this, function ():String{
                ...
                _BottomRightBadge_Label1.text = _arg1;
            }, "_BottomRightBadge_Label1.text");
            result[1] = binding;
            binding = new Binding(this, function ():uint{
                return (roomVO.textColour1);
            }, function (_arg1:uint):void{
                _BottomRightBadge_Label1.setStyle("color", _arg1);
            }, "_BottomRightBadge_Label1.color");
            result[2] = binding;
            return (result);
        }
        ...
        private function _BottomRightBadge_bindingExprs():void{
            var _local1:*;
        ...
        override public function initialize():void{
            ...
            var bindings:* = _BottomRightBadge_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_components_BottomRightBadgeWatcherSetupUtil");
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            BottomRightBadge._watcherSetupUtil = _arg1;
        }
