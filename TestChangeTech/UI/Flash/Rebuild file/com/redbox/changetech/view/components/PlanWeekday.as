...
package com.redbox.changetech.view.components {
    ...
    public class PlanWeekday extends GradientCanvas implements IBindingClient {

        public var _PlanWeekday_Spacer1:Spacer
        private var _plan:Consumption
        private var _3178259goal:Text
        ...
        private var _3076014date:Label
        ...
        public var _PlanWeekday_SetProperty1:SetProperty
        public var _PlanWeekday_SetProperty2:SetProperty
        ...
        public function PlanWeekday(){
            _documentDescriptor_ = new UIComponentDescriptor({type:GradientCanvas, propertiesFactory:function ():Object{
                return ({width:150, height:210, childDescriptors:[new UIComponentDescriptor({type:VBox, stylesFactory:function ():void{
                    ...
                    return ({childDescriptors:[new UIComponentDescriptor({type:Label, id:"day", propertiesFactory:function ():Object{
                    ...
                    }}), new UIComponentDescriptor({type:Label, id:"date", propertiesFactory:function ():Object{
                        return ({styleName:"date"});
                    }}), new UIComponentDescriptor({type:HRule, stylesFactory:function ():void{
                        this.strokeWidth = 1;
                        this.strokeColor = 0xDADADA;
                    }, propertiesFactory:function ():Object{
                        return ({percentWidth:100});
                    }}), new UIComponentDescriptor({type:Text, id:"goal", stylesFactory:function ():void{
                        ...
                        return ({condenseWhite:true});
                    }}), new UIComponentDescriptor({type:Spacer, id:"_PlanWeekday_Spacer1", propertiesFactory:function ():Object{
                        return ({height:10});
            ...
            this.states = [_PlanWeekday_State1_c(), _PlanWeekday_State2_c()];
            this.filters = [_PlanWeekday_DropShadowFilter1_c(), _PlanWeekday_GlowFilter1_i(), _PlanWeekday_GlowFilter2_i()];
        }
        private function _PlanWeekday_State2_c():State{
            var _local1:State = new State();
            _local1.name = "default";
            _local1.overrides = [_PlanWeekday_SetProperty2_i()];
            return (_local1);
        }
        private function get _continue():Boolean{
            return (this._476684794_continue);
        }
        public function get goal():Text{
            return (this._3178259goal);
        }
        ...
        private function _PlanWeekday_GlowFilter1_i():GlowFilter{
        ...
        public function set goal(_arg1:Text):void{
            var _local2:Object = this._3178259goal;
            if (_local2 !== _arg1){
                this._3178259goal = _arg1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "goal", _local2, _arg1));
            };
        }
        ...
        private function _PlanWeekday_DropShadowFilter1_c():DropShadowFilter{
        ...
        private function _PlanWeekday_State1_c():State{
            var _local1:State = new State();
            _local1.name = "selected";
            _local1.overrides = [_PlanWeekday_SetProperty1_i()];
            return (_local1);
        }
        private function _PlanWeekday_SetProperty2_i():SetProperty{
            var _local1:SetProperty = new SetProperty();
            _PlanWeekday_SetProperty2 = _local1;
            _local1.name = "filters";
            BindingManager.executeBindings(this, "_PlanWeekday_SetProperty2", _PlanWeekday_SetProperty2);
            return (_local1);
        }
        ...
        public function set date(_arg1:Label):void{
            var _local2:Object = this._3076014date;
            if (_local2 !== _arg1){
                this._3076014date = _arg1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "date", _local2, _arg1));
            };
        }
        ...
        private function _PlanWeekday_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
            binding = new Binding(this, function ():Object{
                return (this);
            }, function (_arg1:Object):void{
                _PlanWeekday_SetProperty1.target = _arg1;
            }, "_PlanWeekday_SetProperty1.target");
            result[0] = binding;
            binding = new Binding(this, function (){
                return ([selectedGlow]);
            }, function (_arg1):void{
                _PlanWeekday_SetProperty1.value = _arg1;
            }, "_PlanWeekday_SetProperty1.value");
            result[1] = binding;
            binding = new Binding(this, function ():Object{
                return (this);
            }, function (_arg1:Object):void{
                _PlanWeekday_SetProperty2.target = _arg1;
            }, "_PlanWeekday_SetProperty2.target");
            result[2] = binding;
            binding = new Binding(this, function (){
                return ([defaultGlow]);
            }, function (_arg1):void{
                _PlanWeekday_SetProperty2.value = _arg1;
            }, "_PlanWeekday_SetProperty2.value");
            result[3] = binding;
            ...
            result[4] = binding;
            binding = new Binding(this, function ():String{
                var _local1:* = model.languageVO.getLocalDateString(consumption.ConsumptionDate);
                var _local2:* = ((_local1 == undefined)) ? null : String(_local1);
                return (_local2);
            }, function (_arg1:String):void{
                date.text = _arg1;
            ...
            result[5] = binding;
            binding = new Binding(this, function ():String{
                var _local1:* = ((((model.languageVO.getLang("goal") + ": ") + goalTotal) + " ") + model.languageVO.getLang("Drinks"));
                var _local2:* = ((_local1 == undefined)) ? null : String(_local1);
                return (_local2);
            }, function (_arg1:String):void{
                goal.htmlText = _arg1;
            ...
            result[7] = binding;
            binding = new Binding(this, function ():String{
                var _local1:* = ((((model.languageVO.getLang("new_goal") + " ") + plan.PlanValue) + " ") + model.languageVO.getLang("Drinks"));
                var _local2:* = ((_local1 == undefined)) ? null : String(_local1);
                return (_local2);
            }, function (_arg1:String):void{
                newGoal.text = _arg1;
            ...
            binding = new Binding(this, function ():Boolean{
                ...
                _PlanWeekday_Spacer1.visible = _arg1;
            }, "_PlanWeekday_Spacer1.visible");
            result[10] = binding;
        ...
        private function _PlanWeekday_SetProperty1_i():SetProperty{
            var _local1:SetProperty = new SetProperty();
            _PlanWeekday_SetProperty1 = _local1;
            _local1.name = "filters";
            BindingManager.executeBindings(this, "_PlanWeekday_SetProperty1", _PlanWeekday_SetProperty1);
            return (_local1);
        }
        ...
        override public function initialize():void{
            ...
            var bindings:* = _PlanWeekday_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_components_PlanWeekdayWatcherSetupUtil");
        ...
        private function _PlanWeekday_bindingExprs():void{
            var _local1:*;
            _local1 = this;
            ...
            _local1 = model.languageVO.getLocalDateString(consumption.ConsumptionDate);
            _local1 = ((((model.languageVO.getLang("goal") + ": ") + goalTotal) + " ") + model.languageVO.getLang("Drinks"));
            _local1 = ((((model.languageVO.getLang("drank") + ": ") + consumption.total(false)) + " ") + model.languageVO.getLang("Drinks"));
            _local1 = ((((model.languageVO.getLang("new_goal") + " ") + plan.PlanValue) + " ") + model.languageVO.getLang("Drinks"));
            _local1 = isEditMode;
            _local1 = isEditMode;
        ...
        public function get date():Label{
        ...
        private function _PlanWeekday_GlowFilter2_i():GlowFilter{
            var _local1:GlowFilter = new GlowFilter();
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            PlanWeekday._watcherSetupUtil = _arg1;
        }
