...
package com.redbox.changetech.view.templates {
    ...
    public class PicLeftInfoText extends ModuleViewTemplate implements IBindingClient {

        private var _811296866contentImage:BalanceImageReflectionCanvas
        public var _PicLeftInfoText_Spacer1:Spacer
        ...
        private var _567321856contentY:Number
        ...
        public function PicLeftInfoText(){
            _documentDescriptor_ = new UIComponentDescriptor({type:ModuleViewTemplate, propertiesFactory:function ():Object{
                return ({childDescriptors:[new UIComponentDescriptor({type:Canvas, id:"transContainer1", propertiesFactory:function ():Object{
                    return ({verticalScrollPolicy:"on", childDescriptors:[new UIComponentDescriptor({type:VBox, id:"info", stylesFactory:function ():void{
                    ...
                    return ({verticalScrollPolicy:"off", childDescriptors:[new UIComponentDescriptor({type:HBox, propertiesFactory:function ():Object{
                        return ({childDescriptors:[new UIComponentDescriptor({type:Spacer, id:"_PicLeftInfoText_Spacer1"}), new UIComponentDescriptor({type:BalanceImageReflectionCanvas, id:"contentImage"})]});
                    }})]});
                }})]});
            }});
            _bindings = [];
            ...
            this.addEventListener("creationComplete", ___PicLeftInfoText_ModuleViewTemplate1_creationComplete);
        }
        private function get contentY():Number{
            return (this._567321856contentY);
        }
        private function setContentY():void{
            trace(("info.height=" + info.height));
            trace(("model.currentStageHeight=" + model.currentStageHeight));
            contentY = Math.max(((model.currentStageHeight / 2) - (info.height / 2)), 0);
            trace(("contentY=" + contentY));
        }
        private function set contentY(_arg1:Number):void{
            var _local2:Object = this._567321856contentY;
            if (_local2 !== _arg1){
                this._567321856contentY = _arg1;
                this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this, "contentY", _local2, _arg1));
            };
        }
        ...
        override public function initialize():void{
            ...
            var bindings:* = _PicLeftInfoText_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_templates_PicLeftInfoTextWatcherSetupUtil");
        ...
        private function _PicLeftInfoText_bindingExprs():void{
            var _local1:*;
            _local1 = model.currentStageWidth;
            _local1 = model.currentStageHeight;
            _local1 = (contentImage.x + contentImage.width);
            _local1 = Math.max(((model.currentStageHeight / 2) - (info.height / 2)), 0);
        ...
        private function _PicLeftInfoText_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
            ...
            result[2] = binding;
            binding = new Binding(this, function ():Number{
                return (Math.max(((model.currentStageHeight / 2) - (info.height / 2)), 0));
            }, function (_arg1:Number):void{
                info.y = _arg1;
            }, "info.y");
            result[3] = binding;
            ...
            binding = new Binding(this, function ():Number{
                ...
                _PicLeftInfoText_Spacer1.width = _arg1;
            }, "_PicLeftInfoText_Spacer1.width");
            result[21] = binding;
            binding = new Binding(this, function ():String{
        ...
        public function ___PicLeftInfoText_ModuleViewTemplate1_creationComplete(_arg1:FlexEvent):void{
            init(_arg1);
        }
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            PicLeftInfoText._watcherSetupUtil = _arg1;
        }
