...
package com.redbox.changetech.view.templates {
    ...
    public class TypicalWeekCompletion extends ModuleViewTemplate implements IBindingClient {
        ...
        public var _TypicalWeekCompletion_Weekday1:Weekday
        public var _TypicalWeekCompletion_Weekday3:Weekday
        public var _TypicalWeekCompletion_Weekday4:Weekday
        private var _1549852824transContainer1:Canvas
        public var _TypicalWeekCompletion_Weekday6:Weekday
        public var _TypicalWeekCompletion_Weekday7:Weekday
        private var _1266285217friday:GridItem
        mx_internal var _bindings:Array
        private var _documentDescriptor_:UIComponentDescriptor
        public var _TypicalWeekCompletion_Weekday2:Weekday
        public var _TypicalWeekCompletion_Weekday5:Weekday

        private static var _watcherSetupUtil:IWatcherSetupUtil;

        public function TypicalWeekCompletion(){
                ...
                return ({childDescriptors:[new UIComponentDescriptor({type:Canvas, id:"transContainer1", propertiesFactory:function ():Object{
                            ...
                            return ({percentWidth:100, childDescriptors:[new UIComponentDescriptor({type:Grid, id:"grid", stylesFactory:function ():void{
                                ...
                                return ({childDescriptors:[new UIComponentDescriptor({type:GridRow, id:"row1", propertiesFactory:function ():Object{
                                    return ({childDescriptors:[new UIComponentDescriptor({type:GridItem, id:"monday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday1"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"tuesday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday2"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"wednesday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday3"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"thursday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday4"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"friday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday5"})]});
                                    }})]});
                                    ...
                                    return ({childDescriptors:[new UIComponentDescriptor({type:GridItem, id:"saturday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday6"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"sunday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:Weekday, id:"_TypicalWeekCompletion_Weekday7"})]});
                                    }})]});
                                }})]});
                            }})]});
                        }})]});
                    ...
                    return ({horizontalScrollPolicy:"off", verticalScrollPolicy:"off", childDescriptors:[new UIComponentDescriptor({type:VBox, id:"rightsideContainer", stylesFactory:function ():void{
                        ...
                        return ({horizontalScrollPolicy:"off", verticalScrollPolicy:"off", clipContent:false, childDescriptors:[new UIComponentDescriptor({type:BalanceCustomContentReflectionCanvas, id:"dataEntryContainer", propertiesFactory:function ():Object{
                            return ({width:330, content_arr:[_TypicalWeekCompletion_Spacer1_c(), _TypicalWeekCompletion_WeekdayDataEntry1_i()]});
            ...
            this.addEventListener("creationComplete", ___TypicalWeekCompletion_ModuleViewTemplate1_creationComplete);
        }
        private function _TypicalWeekCompletion_Spacer1_c():Spacer{
        ...
        private function init(_arg1:FlexEvent):void{
            ...
            while (_local4 < _local3.length) {
                _local5 = new Consumption(_local3[_local4], new Date());
                _consumptionValues.addItem(_local5);
                _local2.completionUsage.push(_local5);
                _local4++;
            };
        }
        ...
        private function _TypicalWeekCompletion_bindingExprs():void{
            var _local1:*;
        ...
        override public function initialize():void{
            ...
            var bindings:* = _TypicalWeekCompletion_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_templates_TypicalWeekCompletionWatcherSetupUtil");
        ...
        private function _TypicalWeekCompletion_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
            ...
            binding = new Binding(this, function ():Consumption{
                ...
                _TypicalWeekCompletion_Weekday1.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday1.consumption");
            result[2] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(1) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday2.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday2.consumption");
            result[3] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(2) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday3.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday3.consumption");
            result[4] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(3) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday4.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday4.consumption");
            result[5] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(4) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday5.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday5.consumption");
            result[6] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(5) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday6.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday6.consumption");
            result[7] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(6) as Consumption));
            }, function (_arg1:Consumption):void{
                _TypicalWeekCompletion_Weekday7.consumption = _arg1;
            }, "_TypicalWeekCompletion_Weekday7.consumption");
            result[8] = binding;
            binding = new Binding(this, function ():Number{
                return (model.currentStageWidth);
            }, function (_arg1:Number):void{
        ...
        private function _TypicalWeekCompletion_WeekdayDataEntry1_i():WeekdayDataEntry{
        ...
        public function ___TypicalWeekCompletion_ModuleViewTemplate1_creationComplete(_arg1:FlexEvent):void{
            init(_arg1);
        }
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            TypicalWeekCompletion._watcherSetupUtil = _arg1;
        }
