...
package com.redbox.changetech.view.components.questions {
    ...
    public class SingleLineTextQuestion extends Canvas implements IBindingClient {
        ...
        private var _1363257168inputField:TextInput
        mx_internal var _bindings:Array
        private var _documentDescriptor_:UIComponentDescriptor

        private static var _watcherSetupUtil:IWatcherSetupUtil;

        public function SingleLineTextQuestion(){
            _documentDescriptor_ = new UIComponentDescriptor({type:Canvas, propertiesFactory:function ():Object{
                return ({childDescriptors:[new UIComponentDescriptor({type:HBox, propertiesFactory:function ():Object{
                    return ({percentWidth:100, childDescriptors:[new UIComponentDescriptor({type:TextInput, id:"inputField", events:{focusOut:"__inputField_focusOut", change:"__inputField_change"}, propertiesFactory:function ():Object{
        ...
        override public function initialize():void{
            ...
            var bindings:* = _SingleLineTextQuestion_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_components_questions_SingleLineTextQuestionWatcherSetupUtil");
        ...
        private function _SingleLineTextQuestion_bindingExprs():void{
            var _local1:*;
            _local1 = answer;
        }
        ...
        public function set inputField(_arg1:TextInput):void{
        ...
        private function optionSelected(_arg1:Event):void{
            ...
            trace(("inputField.text=" + inputField.text));
        ...
        private function _SingleLineTextQuestion_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            SingleLineTextQuestion._watcherSetupUtil = _arg1;
        }
