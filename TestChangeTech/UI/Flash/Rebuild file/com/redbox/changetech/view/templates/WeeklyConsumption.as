...
package com.redbox.changetech.view.templates {
    ...
    public class WeeklyConsumption extends ModuleViewTemplate implements IBindingClient {
        ...
        private var _387554584dataEntry:WeeklyConsumptionDataEntry
        ...
        public var _WeeklyConsumption_WeeklyConsumptionWeekday1:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday2:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday3:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday4:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday5:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday6:WeeklyConsumptionWeekday
        public var _WeeklyConsumption_WeeklyConsumptionWeekday7:WeeklyConsumptionWeekday
        ...
        public function WeeklyConsumption(){
                ...
                return ({childDescriptors:[new UIComponentDescriptor({type:Canvas, id:"transContainer1", propertiesFactory:function ():Object{
                            ...
                            return ({percentWidth:100, childDescriptors:[new UIComponentDescriptor({type:Grid, id:"grid", stylesFactory:function ():void{
                                ...
                                return ({childDescriptors:[new UIComponentDescriptor({type:GridRow, id:"row1", propertiesFactory:function ():Object{
                                    return ({childDescriptors:[new UIComponentDescriptor({type:GridItem, id:"monday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday1"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"tuesday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday2"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"wednesday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday3"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"thursday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday4"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"friday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday5"})]});
                                    }})]});
                                    ...
                                    return ({childDescriptors:[new UIComponentDescriptor({type:GridItem, id:"saturday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday6"})]});
                                    }}), new UIComponentDescriptor({type:GridItem, id:"sunday", propertiesFactory:function ():Object{
                                        return ({childDescriptors:[new UIComponentDescriptor({type:WeeklyConsumptionWeekday, id:"_WeeklyConsumption_WeeklyConsumptionWeekday7"})]});
                                    }})]});
                                }})]});
                            }})]});
                        }})]});
                    ...
                    return ({horizontalScrollPolicy:"off", verticalScrollPolicy:"off", childDescriptors:[new UIComponentDescriptor({type:VBox, id:"rightsideContainer", stylesFactory:function ():void{
                        ...
                        return ({horizontalScrollPolicy:"off", verticalScrollPolicy:"off", clipContent:false, childDescriptors:[new UIComponentDescriptor({type:BalanceCustomContentReflectionCanvas, id:"dataEntryContainer", propertiesFactory:function ():Object{
                            return ({width:330, content_arr:[_WeeklyConsumption_Spacer1_c(), _WeeklyConsumption_WeeklyConsumptionDataEntry1_i()]});
            ...
            this.addEventListener("creationComplete", ___WeeklyConsumption_ModuleViewTemplate1_creationComplete);
        }
        private function _WeeklyConsumption_bindingsSetup():Array{
            var binding:* = null;
            var result:* = [];
            ...
            binding = new Binding(this, function ():Consumption{
                ...
                _WeeklyConsumption_WeeklyConsumptionWeekday1.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday1.consumption");
            result[2] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(1) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday2.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday2.consumption");
            result[3] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(2) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday3.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday3.consumption");
            result[4] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(3) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday4.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday4.consumption");
            result[5] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(4) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday5.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday5.consumption");
            result[6] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(5) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday6.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday6.consumption");
            result[7] = binding;
            binding = new Binding(this, function ():Consumption{
                return ((_consumptionValues.getItemAt(6) as Consumption));
            }, function (_arg1:Consumption):void{
                _WeeklyConsumption_WeeklyConsumptionWeekday7.consumption = _arg1;
            }, "_WeeklyConsumption_WeeklyConsumptionWeekday7.consumption");
            result[8] = binding;
            binding = new Binding(this, function ():Number{
                return (model.currentStageWidth);
            }, function (_arg1:Number):void{
        ...
        private function _WeeklyConsumption_Spacer1_c():Spacer{
        ...
        override public function initialize():void{
            ...
            var bindings:* = _WeeklyConsumption_bindingsSetup();
            var watchers:* = [];
            target = this;
            if (_watcherSetupUtil == null){
                watcherSetupUtilClass = getDefinitionByName("_com_redbox_changetech_view_templates_WeeklyConsumptionWatcherSetupUtil");
        ...
        private function _WeeklyConsumption_bindingExprs():void{
            var _local1:*;
        ...
        private function _WeeklyConsumption_WeeklyConsumptionDataEntry1_i():WeeklyConsumptionDataEntry{
            var _local1:WeeklyConsumptionDataEntry = new WeeklyConsumptionDataEntry();
            dataEntry = _local1;
        ...
        public function ___WeeklyConsumption_ModuleViewTemplate1_creationComplete(_arg1:FlexEvent):void{
            init(_arg1);
        }
        ...
        public function get dataEntry():WeeklyConsumptionDataEntry{
        ...
        public function set dataEntry(_arg1:WeeklyConsumptionDataEntry):void{
        ...
        public static function set watcherSetupUtil(_arg1:IWatcherSetupUtil):void{
            WeeklyConsumption._watcherSetupUtil = _arg1;
        }
