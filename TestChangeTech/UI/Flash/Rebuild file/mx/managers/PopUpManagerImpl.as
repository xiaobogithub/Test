    ...
    public class PopUpManagerImpl implements IPopUpManager {
            ...
            if (((_arg1) && (_arg1.parent))){
                ...
                if (_local2){
                    ...
                    if ((_local3 is SystemManagerProxy)){
                        _local4 = new InterManagerRequest(InterManagerRequest.SYSTEM_MANAGER_REQUEST, false, false, "bringToFront", {topMost:_local2.topMost, popUp:_local3});
        ...
        private function hideModalWindow(_arg1:PopUpData, _arg2:Boolean=false):void{
            ...
            if (_local5.useSWFBridge()){
                ...
                _local10 = new SWFBridgeRequest(SWFBridgeRequest.HIDE_MODAL_WINDOW_REQUEST, false, false, null, {skip:((!(_arg1.isRemoteModalWindow)) && (!((_local5 == _local9)))), show:false, remove:_arg2});
            ...
            while (_local3 < _local2) {
                ...
                if (_local5 == _arg1.target){
                    ...
                    if ((_local8 is SystemManagerProxy)){
                        ...
                        _local11 = new SWFBridgeRequest(SWFBridgeRequest.REMOVE_POP_UP_REQUEST, false, false, _local10, {window:DisplayObject(_local8), parent:_local4.parent, modal:!((_local4.modalWindow == null))});
        ...
        public function addPopUp(_arg1:IFlexDisplayObject, _arg2:DisplayObject, _arg3:Boolean=false, _arg4:String=null):void{
            ...
            if (_local6.useSWFBridge()){
                if (_local10 != _local6){
                    ...
                    _local11 = new SWFBridgeRequest(SWFBridgeRequest.ADD_POP_UP_REQUEST, false, false, _local6.swfBridgeGroup.parentBridge, {window:DisplayObject(_local9), parent:_arg2, modal:_arg3, childList:_arg4});
        ...
        private function dispatchModalWindowRequest(_arg1:String, _arg2:ISystemManager, _arg3:DisplayObject, _arg4:PopUpData, _arg5:Boolean):void{
            ...
            var _local6:SWFBridgeRequest = new SWFBridgeRequest(_arg1, false, false, null, {skip:((!(_arg4.isRemoteModalWindow)) && (!((_arg2 == _arg3)))), useExclude:_arg4.useExclude, show:_arg5, remove:false, transparencyDuration:_arg4.modalTransparencyDuration, transparency:_arg4.modalTransparency, transparencyColor:_arg4.modalTransparencyColor, transparencyBlur:_arg4.modalTransparencyBlur});
