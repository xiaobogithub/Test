    ...
    public class List extends ListBase implements IIMESupport {
        ...
        private function itemEditorItemEditBeginningHandler(_arg1:ListEvent):void{
            if (!_arg1.isDefaultPrevented()){
                setEditedItemPosition({columnIndex:_arg1.columnIndex, rowIndex:_arg1.rowIndex});
            } else {
        ...
        public function set editedItemPosition(_arg1:Object):void{
            var _local2:Object = {rowIndex:_arg1.rowIndex, columnIndex:0};
                    ...
                    if (editedItemPosition){
                        if (collection.length == 0){
                            ...
                            if (_local2.location <= editedItemPosition.rowIndex){
                                if (inEndEdit){
                                    _editedItemPosition = {columnIndex:editedItemPosition.columnIndex, rowIndex:Math.max(0, (editedItemPosition.rowIndex - _local2.items.length))};
                                } else {
                                    setEditedItemPosition({columnIndex:editedItemPosition.columnIndex, rowIndex:Math.max(0, (editedItemPosition.rowIndex - _local2.items.length))});
                                };
                            };
                        };
                    };
