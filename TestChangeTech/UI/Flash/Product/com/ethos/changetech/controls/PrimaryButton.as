package com.ethos.changetech.controls{
	...
	public class PrimaryButton extends ColorableSprite {
		...
		public function PrimaryButton(_currentPage:Page) {
			_page = _currentPage;
			initValue();
			initButton();
			initBackground();
		...
		override public function set height(_value:Number):void {
			throw new IllegalOperationError("Can not set height for com.ethos.changetech.controls.PrimaryButton");
		}
		...
		public function set label(_value:String):void {
			if (_value == _labelTextField.text) {
				return;
			}
		...
		private function initValue():void{
			...
			_buttonColorNormal = _page.pageSequence.PrimaryButtonColorNormal.split(",");
			_buttonColorOver = _page.pageSequence.PrimaryButtonColorOver.split(",");
			_buttonColorDown = _page.pageSequence.PrimaryButtonColorDown.split(",");
		}
		...
		private function layout():void {
			...
			_labelTextField.y = (bg_mc.height - _labelTextField.textHeight) / 2;
		}
