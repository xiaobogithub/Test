package com.ethos.changetech.controls{
	...
	public class MessageBoxContentProgramStatusTemplate extends MessageBoxContentTemplate {
		...
		public function MessageBoxContentProgramStatusTemplate(_object:MessageObject, _w:Number) {
			super(_object, _w);
		}
		...
		override protected function initLayout():void {
			...
			switch(_type) {
				case "pause" :
					...
					break;
				case "exit" :
					_submitButtonWidth = GlobalValue.getValue("layout")["ExitProgramSubmitButtonWidth"];
					break;
				default:
					throw new IllegalOperationError("Invalid program status setting type.");
			}			
		}
				...
				case "0" :
					switch(_type) {
						case "pause" :
							...
							break;
						case "exit" :
							_feedbackTextField.htmlText = "<messageBoxFailedFeedback>" + GlobalValue.getValue("messages")["ExitProgramFailed"].message + "</messageBoxFailedFeedback>";
							break;
						default:
							throw new IllegalOperationError("Invalid program status setting type.");
					}	
				...
				case "1" :
					switch(_type) {
						case "pause" :
							...
							break;
						case "exit" :
							_feedbackTextField.htmlText = "<messageBoxSuccessfulFeedback>" + GlobalValue.getValue("messages")["ExitProgramSuccessful"].message + "</messageBoxSuccessfulFeedback>";
							break;
						default:
							throw new IllegalOperationError("Invalid program status setting type.");
					}
