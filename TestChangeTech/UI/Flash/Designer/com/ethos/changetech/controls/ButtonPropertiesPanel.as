package com.ethos.changetech.controls{
	...
	public class ButtonPropertiesPanel extends PropertiesPanel {
		//Refactoring: this one is exactely the same as RadioButtonPropertiesPanel

		public function ButtonPropertiesPanel() {
			...
			heightTextField.restrict = "0-9";
			heightTextField.addEventListener(Event.CHANGE, heightChangeHandler);
		...
		private function heightChangeHandler(_event:Event):void{
			if(Number(heightTextField.text)>(600-target.y)){
				heightTextField.text = (600 - target.x).toString();
			}
