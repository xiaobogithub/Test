package com.ethos.changetech.controls{
	...
	public class TextBlockPropertiesPanel extends PropertiesPanel {

		public function TextBlockPropertiesPanel() {
			//backgroundColorPicker.enabled = false;
			...
			textTextField.addEventListener(Event.CHANGE, textChangeHandler);
		}
		override protected function updateProperties():void {
			//trace("TextBlock properties panel updating.");
			updateLocation();
			...
			textTextField.text = target.text;
		}
		...
		private function textChangeHandler(_event:Event):void{
			target.text = textTextField.text;
			updateHeight();
		}
	}
}