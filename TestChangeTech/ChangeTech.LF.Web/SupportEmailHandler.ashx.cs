    ...
    public class SupportEmailHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                string emailTo = System.Web.HttpUtility.UrlEncode(context.Request.Params["emailTo"]);
                ...
                string post = "subject=" + subject + "&body=" + body + "&emailTo=" + emailTo + "&emailFromAddress=" + emailFromAddress + "&emailFromName=" + emailFromName;
